...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    const titleCandidates = [
      '💝 Amazonほしい物ランキング　カテゴリ別リンクまとめ | アマゾン | Amazon | ランキング | おすすめ | お得 | 買ってよかった | フォロバ100 | フォロバ',
      '🎁 Amazonほしい物ランキング　保存して賢くお買い物 | アマゾン | Amazon | ランキング | おすすめ | お得 | 買ってよかった | フォロバ100 | フォロバ',
      '📝 Amazonほしい物ランキング　気になる商品を比較・管理 | アマゾン | Amazon | ランキング | おすすめ | お得 | 買ってよかった | フォロバ100 | フォロバ',
      '✨ Amazonほしい物ランキング　ギフト選びの近道 | アマゾン | Amazon | ランキング | おすすめ | お得 | 買ってよかった | フォロバ100 | フォロバ',
    ];
    ...
    const intro = [
      ...
      'また、コメントを頂けますと大変励みになります✨ ご意見等どういった内容でもお待ちしておりますので気軽にコメントいただければと思います💫',
      '',
      '---',
    ].join('\n');
    ...
    const closing = [
      ...
      '',
      '#Amazonランキング #アマゾン #Amazon #ranking #ほしい物リスト #買ってよかった #ウィッシュリスト #おすすめ #ショッピング #PR',
    ].join('\n');
